...
```bash
lucide-react, react-day-picker, @radix-ui/react-scroll-area, @radix-ui/react-separator, @radix-ui/react-collapsible, @radix-ui/react-slot, class-variance-authority
```
