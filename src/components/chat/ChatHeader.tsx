...
export function ChatHeader() {
  ...
  return (
    <header className="border-b p-3 flex items-center justify-between bg-background sticky top-0 z-30 shadow-sm">
      ...
      {showProjectPanel && (
        <div className="fixed inset-0 z-40 bg-black/30 backdrop-blur-sm" onClick={() => setShowProjectPanel(false)}>
          <div 
            className="fixed top-0 right-0 bottom-0 z-50 w-80 md:w-96 shadow-xl bg-background"
